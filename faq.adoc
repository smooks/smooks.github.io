...
https://github.com/smooks/smooks-examples/tree/v5[tutorials].
...
Check out the
https://github.com/smooks/smooks-examples/tree/v5/java-basic[java-basic]
tutorial.
...
https://github.com/smooks/smooks-examples/tree/v5/xslt-groovy[xslt-groovy
...
https://github.com/smooks/smooks-examples/tree/v5/edi-to-xml[edi-to-xml]
and
https://github.com/smooks/smooks-examples/tree/v5/csv-to-xml[csv-to-xml]
tutorials.
