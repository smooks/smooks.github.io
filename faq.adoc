...
https://github.com/smooks/smooks-examples/tree/v6[tutorials].
...
Check out the
https://github.com/smooks/smooks-examples/tree/v6/java-basic[java-basic]
tutorial.
...
https://github.com/smooks/smooks-examples/tree/v6/xslt-groovy[xslt-groovy
...
https://github.com/smooks/smooks-examples/tree/v6/edi-to-xml[edi-to-xml]
and
https://github.com/smooks/smooks-examples/tree/v6/csv-to-xml[csv-to-xml]
tutorials.
