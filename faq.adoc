...
https://github.com/smooks/smooks-examples/tree/v4[tutorials].
...
Check out the
https://github.com/smooks/smooks-examples/tree/v4/java-basic[java-basic]
tutorial.
...
https://github.com/smooks/smooks-examples/tree/v4/xslt-groovy[xslt-groovy
...
https://github.com/smooks/smooks-examples/tree/v4/edi-to-xml[edi-to-xml]
and
https://github.com/smooks/smooks-examples/tree/v4/csv-to-xml[csv-to-xml]
tutorials.
