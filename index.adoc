...
The Smooks engine known as the _Smooks Core_ is a lightweight library that can be added to your Java project as follows:
...
[source,groovy]
----
implementation 'org.smooks:smooks-core:2.0.0'
----
====
