...
[source,scala]
----
libraryDependencies += "org.smooks" % "smooks" % "2.0.0" pomOnly()
----
====
...
Process huge messages (gigabytes!). Split, transform and route fragments to JMS, filesystem, database, and other destinations.
