...
*Smooks* is an open-source, extensible data integration Java framework for building event-driven applications that process XML and non-XML data in a fragment-based way.
